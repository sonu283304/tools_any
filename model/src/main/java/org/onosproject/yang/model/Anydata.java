...
public interface Anydata {
     ...
     */
    void addAnydata(InnerModelObject obj);
     ...
     * @param obj model object of augmentation
     */
    void removeAnydata(InnerModelObject obj);
     ...
     */
    Map<Class<? extends InnerModelObject>, InnerModelObject> anydatas();
     ...
     */
    <T extends InnerModelObject> T anydata(Class<T> c);
}
